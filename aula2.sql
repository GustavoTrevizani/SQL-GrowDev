...
insert into pessoa(id, nome, idade, renda, familia_id) values(3,'Bart', 12, 200, 1);
...
insert into pessoa(id, nome, idade, renda, familia_id) values(7,'Mortícia', 35, 8000, 2);
...
insert into pessoa(id, nome, idade, renda, familia_id) values(13,'Mãozinha', 2, 20, 2);